import { Share2, PlayCircle, CheckCircle2, Play, Lock, FileText, ExternalLink, List, FileQuestion, ChevronRight, BookOpen, Clock } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col w-full h-full">
        ...
        <div className="border-b border-outline-variant mb-8" data-purpose="workspace-tabs">
          <nav className="flex gap-8 overflow-x-auto custom-scrollbar">
            <a className="pb-4 font-label-md text-[14px] font-bold text-primary border-b-2 border-primary uppercase tracking-wider whitespace-nowrap" href="#">
              Topics
            </a>
            <a className="pb-4 font-label-md text-[14px] font-semibold text-secondary hover:text-on-surface border-b-2 border-transparent hover:border-outline-variant uppercase tracking-wider transition-colors whitespace-nowrap" href="#">
              Resources
            </a>
            <a className="pb-4 font-label-md text-[14px] font-semibold text-secondary hover:text-on-surface border-b-2 border-transparent hover:border-outline-variant uppercase tracking-wider transition-colors whitespace-nowrap" href="#">
              Notes
